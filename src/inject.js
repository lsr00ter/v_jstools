function make_v(envs, keys) {
  ...
  v_new_htmlmap["HTMLAnchorElement"] = ["a"]; // 确保 a 标签存在
...
`,
  ...
  tail.push(``);
  tail.push(`v_repair_this() // 修复 window 指向 global`);
...
function injectfunc(e, window, init_log) {
  ...
  if ((e["config-hook-regexp-url"] || "").trim()) {
    console.log(
      "[*] 配置了只收集对某个 js 路径才输出的配置（如出现控制台不输出 hook，注意配置该项为空）:",
        ...
        if (cache[a[0]] > log_limit) {
          if (!close_tog[a[0]]) {
            ...
            v_console_dbg_log(
              ...
              "超过接口的输出上限:",
              log_limit,
              ", 停止输出该接口的日志.（默认 30，可在“打开配置页面” ==> “dom 对象 hook 配置” ==> 红色窗口中配置）"
            );
          }
          return;
        }
  ...
  function saf_noprototype(f, name, length) {
    ...
    Object.defineProperties(r, {
      length: {
        value: typeof length == "number" ? length : f.length,
        writable: false,
        enumerable: false,
        configurable: true,
      },
  ...
  if (e["config-hook-random"] && e["config-hook-random-freeze"]) {
    Math.random = saf_noprototype(function random() {
      return 0.5;
    });
  }
  if (e["config-hook-random"] && e["config-hook-random-fake"]) {
    Math.random = saf_noprototype(
      (function (seed) {
  ...
  if (e["config-hook-random"] && e["config-hook-time-freeze"]) {
    ...
    Date.now = saf_noprototype(function now() {
      return ftime;
    });
  }
  if (e["config-hook-random"] && e["config-hook-time-performance"]) {
    var v_perfnow = 1024; // 固定返回一个数字
    Performance.prototype.now = saf_noprototype(function now() {
      return v_perfnow;
    });
  }
        ...
        function replace_debugger(e) {
          if (/debugger/.test(e[e.length - 1])) {
            ...
            if (temp.indexOf(e[e.length - 1]) == -1) {
              temp.push(e[e.length - 1]);
              var loglist = _mk_logs(
                `[replace_debugger:${fname}]: ${e[e.length - 1]}`
              );
              if (check_over_limit(loglist)) {
                v_console_dbg_log(...loglist);
              }
  ...
  if (e["config-hook-cookie"]) {
    !(function () {
      // hook cookie get set
      var _old_cookie_get = Object.getOwnPropertyDescriptors(Document.prototype)
        .cookie.get;
      var _old_cookie_set = Object.getOwnPropertyDescriptors(Document.prototype)
        .cookie.set;
  ...
  if (e["config-hook-settimeout"]) {
    !(function () {
      ...
      setTimeout = saf_noprototype(function setTimeout() {
        if (e["config-hook-settimeout"]) {
          if (
            expurl.v_test((expstr = c_split(v_Error().stack || "", "\n")[3])) &&
      ...
      JSON.parse = saf_noprototype(function parse(a, b) {
        ...
        return e["config-hook-JSON.parse"]
          ? (v_console_dbg_log(
              ...
              ..._mk_logs(...arguments),
              "===>",
              (temp = v_parse.apply(this, arguments))
            ),
            temp)
      ...
      JSON.stringify = saf_noprototype(function stringify(a, b, c) {
        ...
        return e["config-hook-JSON.stringify"]
          ? (v_console_dbg_log(
              ...
              ..._mk_logs(...arguments),
              "===>",
              (temp = v_stringify.apply(this, arguments))
            ),
            temp)
      ...
      decodeURI = saf_noprototype(function decodeURI(a) {
        ...
        return e["config-hook-decodeURI"]
          ? (v_console_dbg_log(
              ...
              ..._mk_logs(...arguments),
              "===>",
              (temp = v_decodeURI.apply(this, arguments))
            ),
            temp)
      ...
      decodeURIComponent = saf_noprototype(function decodeURIComponent(a) {
        ...
        return e["config-hook-decodeURIComponent"]
          ? (v_console_dbg_log(
              ...
              ..._mk_logs(...arguments),
              "===>",
              (temp = v_decodeURIComponent.apply(this, arguments))
            ),
            temp)
      ...
      encodeURI = saf_noprototype(function encodeURI(a) {
        ...
        return e["config-hook-encodeURI"]
          ? (v_console_dbg_log(
              ...
              ..._mk_logs(...arguments),
              "===>",
              (temp = v_encodeURI.apply(this, arguments))
            ),
            temp)
      ...
      encodeURIComponent = saf_noprototype(function encodeURIComponent(a) {
        ...
        return e["config-hook-encodeURIComponent"]
          ? (v_console_dbg_log(
              ...
              ..._mk_logs(...arguments),
              "===>",
              (temp = v_encodeURIComponent.apply(this, arguments))
            ),
            temp)
      ...
      escape = saf_noprototype(function escape(a) {
        ...
        return e["config-hook-escape"]
          ? (v_console_dbg_log(
              ...
              ..._mk_logs(...arguments),
              "===>",
              (temp = v_escape.apply(this, arguments))
            ),
            temp)
      ...
      unescape = saf_noprototype(function unescape(a) {
        ...
        return e["config-hook-unescape"]
          ? (v_console_dbg_log(
              ...
              ..._mk_logs(...arguments),
              "===>",
              (temp = v_unescape.apply(this, arguments))
            ),
            temp)
      ...
      atob = saf_noprototype(function atob(a) {
        ...
        return e["config-hook-atob"]
          ? (v_console_dbg_log(
              ...
              ..._mk_logs(...arguments),
              "===>",
              (temp = v_atob.apply(this, arguments))
            ),
            temp)
      ...
      btoa = saf_noprototype(function btoa(a) {
        ...
        return e["config-hook-btoa"]
          ? (v_console_dbg_log(
              ...
              ..._mk_logs(...arguments),
              "===>",
              (temp = v_btoa.apply(this, arguments))
            ),
            temp)
  ...
  var CustomEvent_detail_getter = Date.call.bind(
  ...
  window.addEventListener("$magic_listener", function (e) {
    ...
    if (detail) {
      if (detail.action == "eval") {
        v_Function("v_env_list_log,logtogglefunc", detail.data)(
          v_env_list_log,
          logtogglefunc
        );
      }
...
chrome.runtime.onMessage.addListener(function (msg, sender, sendResponse) {
  ...
  if (msg.action.type == "addlistener") {
    delay_inject(
      `try{v_env_list_log()}catch(e){debugger;alert('请打开调试总开关，同时将dom挂钩全部选中后，再刷新页面点击代码生成按钮。')}`
    );
  }
...
chrome.runtime.sendMessage(
  { getcookie: true, domain: document.domain },
  function (res) {}
);
